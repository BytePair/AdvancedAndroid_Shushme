...
public class MainActivity extends AppCompatActivity implements GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener, LoaderManager.LoaderCallbacks<Cursor> {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAddLocationButton = (Button) findViewById(R.id.add_new_location_button);
        ...
        // COMPLETE (4) Create a GoogleApiClient with the LocationServices API and GEO_DATA_API
    ...
    public void onAddPlaceButtonClicked(View view) {
        if (ActivityCompat.checkSelfPermission(this, Manifest.permission.ACCESS_FINE_LOCATION) != PackageManager.PERMISSION_GRANTED) {
            ...
            Toast.makeText(this, "Location Permissions Grantewd", Toast.LENGTH_SHORT).show();
        }
    }
