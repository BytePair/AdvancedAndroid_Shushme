...
public class MainActivity extends AppCompatActivity implements
    ...
    public void refreshPlacesData() {
        ...
        while (data.moveToNext()) {
            Log.i(TAG, data.getString(data.getColumnIndex(PlaceContract.PlaceEntry.COLUMN_PLACE_ID)));
        ...
        PendingResult<PlaceBuffer> placeBufferPendingResult =
                Places.GeoDataApi.getPlaceById(mGoogleApiClient, ids.toArray(new String[ids.size()]));
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLACE_PICKER_REQUEST && resultCode == RESULT_OK) {
            ...
            // Refresh places data with new place added
            refreshPlacesData();
        }
    }
